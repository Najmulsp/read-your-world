...
const BookDetails = () => {
 ...
 const handleWishlistBook = () =>{
    ...
    return (
        <div className="container  lg:mx-auto  flex flex-col lg:flex-row border rounded-2xl bg-gray-200 lg:gap-16 mt-10">
           <div className="ml-12 lg:ml-20   pt-16 w-4/5 lg:w-1/3">
                <img src={image} alt="" />
            </div>
